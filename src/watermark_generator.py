...
owner_img = cv2.imread('images\owner_share.png', 0)

for k in range(0, 1):
    master_img = cv2.imread('images\master_images\master_share.png', 0)
    ...
    cv2.imwrite('images\\regenerated_watermarks\\watermark_img_'+str(k)+'.png', watermark_img)
    print(k)
print("Done")